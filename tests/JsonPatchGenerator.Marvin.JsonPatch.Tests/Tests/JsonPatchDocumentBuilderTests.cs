...
namespace JsonPatchGenerator.Marvin.Json.Tests.Tests
{
    public class JsonPatchDocumentBuilderTests
    {
        ...
        public void BuiltDocumentHasCorrectType() =>
            TestBuild(result => Assert.True(result is JsonPatchDocumentWrapper));

        private void TestBuild(Action<IPatchDocument> assert)
        {
            // arrange
            var target = new JsonPatchDocumentBuilder();
        ...
        private void TestOperation(Operation expectedOperation, Action<JsonPatchDocumentBuilder, Operation> testMethod, Action<Operation, Operation> assert) =>
            TestOperation(
        ...
        private void TestOperation(Action<JsonPatchDocumentBuilder> appendOperationAction, Action<Operation> assert)
        {
            // arrange
            var target = new JsonPatchDocumentBuilder();
